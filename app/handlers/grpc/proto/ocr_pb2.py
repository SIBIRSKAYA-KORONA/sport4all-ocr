...
# source: handlers/grpc/proto/ocr.proto
...
Image = _reflection.GeneratedProtocolMessageType('Image', (_message.Message,), {
    'DESCRIPTOR': _IMAGE,
    '__module__': 'handlers.grpc.proto.ocr_pb2'
