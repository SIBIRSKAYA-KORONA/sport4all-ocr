...
# source: app/handlers/grpc/proto/ocr.proto
...
_IMAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='path', full_name='proto.Image.path', index=0,
...
Image = _reflection.GeneratedProtocolMessageType('Image', (_message.Message,), {
    'DESCRIPTOR': _IMAGE,
    '__module__': 'app.handlers.grpc.proto.ocr_pb2'
